...
<%
    try {
        String subId = request.getParameter("s") == null ? "" : request.getParameter("s").replaceAll("\\<.*?>", "");
        String mailType = request.getParameter("t") == null ? "" : request.getParameter("t").replaceAll("\\<.*?>", "");
        if ("".equals(subId)) {
            subId = "0";
        } else {
            subId = new String(wawo.security.Base64.decode(subId));
        }
        ...
        cm.unsubscribeNewsletter(subId, mailType);
...
<html class="no-js"  lang="<%=session.getAttribute("isoCode")%>"> 
    ...
    <head>
        ...
        <title itemprop="name">Unsubscribed Successfully</title>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="" style="width:100%;text-align:center">
                        <h3 class="section-title"><%=p.getProperty("public.home.unsubscribe")%></span></h3>
...
<%} catch (Throwable e) {
        Logger.getLogger("unsubscribe.jsp").log(Level.SEVERE, null, e);
    } finally {
    }
%>
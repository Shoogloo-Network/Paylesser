...
try {
    ...
    String news = request.getParameter("n") == null ? "" : request.getParameter("n").replaceAll("\\<.*?>", "");
                                ...
                                if (newsList != null) {
                                    for (News nw : newsList) {
                                        if (nw.getLanguageId().equals(language.getId())) {
                                            if (nw.getParentId().equals(news)) {%>
                                                <li>
                                                    <p><%=nw.getTitle()%></p>
                                                    <p class=""><%=nw.getDescription()%></p>
                                                </li>
                                            <%}
                                        }
                                    }
...
<%} catch (Throwable e) {
    Logger.getLogger("newsDetail.jsp").log(Level.SEVERE, null, e);
}%>
<%-- 
    Document   : top-20-o
    Created on : 4 Mar, 2016, 4 Mar, 2016 17:49:10 PM
    Author     : Vivek
--%>
...
String voucherDesc = "";
String pageType = "0";
pageType = SystemConstant.TOP_20_O;
String pageTypeFk = "";
...
List<VoucherDeals> offerDealList = home.getTop20OffersByDomainId(domainId);
...
<html lang="<%=langId%>" itemscope itemtype="https://schema.org/WebPage"> 
    ...
    <head>
        ...
        <%for(SeoUrl s : seoList) {
            if(SystemConstant.TOP_20_O.equals(s.getPageType())) {
                        ...
                        <div class="page-header">
                           <div class="row">
                               <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <h1><%=p.getProperty("public.topoffers")%></h1>
                               </div>
                           </div>
...
<%}
    ...
    Logger.getLogger("top-20-o.jsp").log(Level.SEVERE, null, e);
}%>

<%-- 
    Document   : new-vc
    Created on : 7 Mar, 2016, 7 Mar, 2016 11:34:48 AM
    Author     : Vivek
--%>
...
String voucherDesc = "";
String pageType = "0";
pageType = SystemConstant.NEW_VC;
String pageTypeFk = "";
                        ...
                        <div class="page-header">
                           <div class="row">
                               <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <h1><%=p.getProperty("public.newvc.vc")%></h1>
                               </div>
                           </div>
...
<%}
    ...
    Logger.getLogger("new-vc.jsp").log(Level.SEVERE, null, e);
}%>

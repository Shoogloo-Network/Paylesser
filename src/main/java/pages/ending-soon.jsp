...
String voucherDesc = "";
String pageType = "0";
pageType = SystemConstant.ENDING_SOON;
String pageTypeFk = "";
...
List<VoucherDeals> offerDealList = home.getEndingSoonByDomainId(domainId);
...
<html lang="<%=langId%>" itemscope itemtype="https://schema.org/WebPage"> 
    ...
    <head>
        ...
        <%for(SeoUrl s : seoList) {
            if(SystemConstant.ENDING_SOON.equals(s.getPageType())) {
                        ...
                        <div class="page-header">
                           <div class="row">
                               <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <h1><%=p.getProperty("public.endingsoon.heading")%></h1>
                               </div>
                           </div>
...
<%}
    ...
    Logger.getLogger("ending-soon.jsp").log(Level.SEVERE, null, e);
}%>
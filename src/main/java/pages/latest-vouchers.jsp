<%-- 
    Document   : latest-vouchers
    Created on : 7 Mar, 2016, 7 Mar, 2016 12:25:17 PM
    Author     : Vivek
--%>
...
String voucherDesc = "";
String pageType = "0";
pageType = SystemConstant.LATEST_VOUCHERS;
String pageTypeFk = "";
...
List<VoucherDeals> offerDealList = home.getVoucherByDomainId(domainId);
...
<html lang="<%=langId%>" itemscope itemtype="https://schema.org/WebPage"> 
    ...
    <head>
        ...
        <%for(SeoUrl s : seoList) {
            if(SystemConstant.LATEST_VOUCHERS.equals(s.getPageType())) {
                        ...
                        <div class="page-header">
                           <div class="row">
                               <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <h1><%=p.getProperty("public.home.latest")+" "+p.getProperty("public.home.latest_vouchers")%></h1>
                               </div>
                           </div>
...
<%}
    ...
    Logger.getLogger("latest-vouchers.jsp").log(Level.SEVERE, null, e);
}%>

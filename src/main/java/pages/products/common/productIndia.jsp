...
<div class="col-lg-20 col-md-3 col-sm-6 col-xs-6">
        <div class="item">
           <div class="item-img">
               <a class="product-image btn-prod"  data-href="<%=outURL+"?id="+pro.getId()%>" target="_blank" rel="nofollow"> <img class="feed-prod-img" alt="<%=pro.getName()%>" src="<%=SystemConstant.PATH%>images/loading.gif" data-src="<%= cdn + "/"+ SolrUtils.getPathFromUrl(pro.getImageurl())%>"> </a>

<%-- 
    Document   : ending-soon
    Created on : 7 Mar, 2016, 7 Mar, 2016 10:37:40 AM
    Author     : Vivek
--%>
...
String voucherDesc = "";
String pageType = "0";
pageType = SystemConstant.EXCLUSIVE;
String pageTypeFk = "";
...
List<VoucherDeals> offerDealList = home.getExclusiveByDomainId(domainId);
...
<html lang="<%=langId%>" itemscope itemtype="https://schema.org/WebPage"> 
    ...
    <head>
        ...
        <%for(SeoUrl s : seoList) {
            if(SystemConstant.EXCLUSIVE.equals(s.getPageType())) {
                        ...
                        <div class="page-header">
                           <div class="row">
                               <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <h1><%=p.getProperty("public.home.exclusive")%>&nbsp;<%=p.getProperty("public.home.coupons")%></h1>
                               </div>
                           </div>
...
<%}
    ...
    Logger.getLogger("exclusive.jsp").log(Level.SEVERE, null, e);
}%>
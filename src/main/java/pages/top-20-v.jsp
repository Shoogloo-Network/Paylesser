<%-- 
    Document   : top-20-v
    Created on : 7 Mar, 2016, 7 Mar, 2016 10:53:33 AM
    Author     : Vivek
--%>
...
String voucherDesc = "";
String pageType = "0";
pageType = SystemConstant.TOP_20_V;
String pageTypeFk = "";
...
List<VoucherDeals> offerDealList = home.getTop20VCByDomainId(domainId);
...
<html lang="<%=langId%>" itemscope itemtype="https://schema.org/WebPage"> 
    ...
    <head>
        ...
        <%for(SeoUrl s : seoList) {
            if(SystemConstant.TOP_20_V.equals(s.getPageType())) {
                        ...
                        <div class="page-header">
                           <div class="row">
                               <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <h1><%=p.getProperty("public.topvouchers")%></h1>
                               </div>
                           </div>
...
<%}
    ...
    Logger.getLogger("top-20-v.jsp").log(Level.SEVERE, null, e);
}%>

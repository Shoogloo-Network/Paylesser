<%-- 
    Document   : latest-deals
    Created on : 7 Mar, 2016, 7 Mar, 2016 12:42:37 PM
    Author     : Vivek
--%>
...
String voucherDesc = "";
String pageType = "0";
pageType = SystemConstant.LATEST_DEALS;
String pageTypeFk = "";
...
List<VoucherDeals> offerDealList = home.getDealByDomainId(domainId);
...
<html lang="<%=langId%>" itemscope itemtype="https://schema.org/WebPage"> 
    ...
    <head>
        ...
        <%for(SeoUrl s : seoList) {
            if(SystemConstant.LATEST_DEALS.equals(s.getPageType())) {
                        ...
                        <div class="page-header">
                           <div class="row">
                               <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <h1><%=p.getProperty("public.home.latest_deals")%></h1>
                               </div>
                           </div>
...
<%}
    ...
    Logger.getLogger("latest-deals.jsp").log(Level.SEVERE, null, e);
}%>
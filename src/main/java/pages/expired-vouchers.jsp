<%-- 
    Document   : expired-vouchers
    Created on : 7 Mar, 2016, 7 Mar, 2016 11:59:18 AM
    Author     : Vivek
--%>
...
String voucherDesc = "";
String pageType = "0";
pageType = SystemConstant.EXPIRED;
String pageTypeFk = "";
...
List<VoucherDeals> offerDealList = home.getExpiredByDomainId(domainId);
...
<html lang="<%=langId%>" itemscope itemtype="https://schema.org/WebPage"> 
    ...
    <head>
        ...
        <%for(SeoUrl s : seoList) {
            if(SystemConstant.EXPIRED.equals(s.getPageType())) {
    ...
    <div class="store-middle">
        <div class="container ">
            <div class="row">
                        ...
                        <div class="page-header">
                           <div class="row">
                               <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">    
                                    <h1><%=p.getProperty("public.expiredv.heading")%></h1>
                               </div>
                           </div>
                        </div>
                        <!-- -------------------Offer Filter End------------------------->
                ...
                <!-- -------------------Offer Item End------------------------->        
                <!-- -------------------Sidebar Start------------------------->
                <div class="col-lg-pull-9 col-md-pull-9 col-lg-3 col-md-3 col-sm-12 col-xs-12 hidden-xs hidden-sm">
                    <div class="sidebar">  
                        <!-- -----Side Banner 1----->
...
<%}
    ...
    Logger.getLogger("expired-vouchers.jsp").log(Level.SEVERE, null, e);
}%>

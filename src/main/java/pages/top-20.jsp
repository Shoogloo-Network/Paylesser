<%-- 
    Document   : top-20
    Created on : 7 Mar, 2016, 7 Mar, 2016 09:55:10 AM
    Author     : Vivek
--%>
...
try {
    ...
    String voucherDesc = "";
    String pageType = "0";
    pageType = SystemConstant.TOP_20;
    String pageTypeFk = "";
...
<html lang="<%=langId%>" itemscope itemtype="https://schema.org/WebPage"> 
        ...
        <head>
            ...
            <%for(SeoUrl s : seoList) {
                if(SystemConstant.TOP_20.equals(s.getPageType())) {
                        ...
                        <div class="page-header">
                           <div class="row">
                               <div class="col-lg-10 col-md-10 col-sm-10 col-xs-12">
                                    <h1><%=p.getProperty("public.toptwenty")%></h1>
                               </div>
                           </div>
...
<%} 
    ...
    Logger.getLogger("top-20.jsp").log(Level.SEVERE, null, e);
}%>
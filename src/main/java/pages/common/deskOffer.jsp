<%-- 
    Document   : offerList
    Created on : 16 Mar, 2016, 16 Mar, 2016 3:52:42 PM
    Author     : Vivek
--%>
...
<%if ("1".equals(vd.getOfferType())) {
 if("1".equals(vd.getExclusive())){%>                
    <div class="offer-item exclusive desk-offer-content coupon">
<%}else{%> 
    <div class="offer-item desk-offer-content coupon">
<%} } else {
 if("1".equals(vd.getExclusive())){
%>                
    <div class="offer-item exclusive desk-offer-content offer">
<%}else{%> 
        ...
        <div class="item-top">
                  ...
                  <%
                   if ("2".equals(vd.getOfferType()) && vd.getOfferImage() != null && !"".equals(vd.getOfferImage())) {
                    if (SystemConstant.COUPON_DATILS.equals(seoObj1.getPageType())) {  
                       ...
                       <%}else{%>
                         <figure class="lazy"><img src="<%=SystemConstant.PATH%>images/loading.gif" data-src="<%=cdnPath + vd.getImageSmall()%>" class="lazy" alt="<%=vd.getStoreName()%> voucher" title="<%=vd.getStoreName()%> offers"></figure>
                       <% }
            ...
            <div class="col-lg-7 col-md-7 col-sm-7 col-xs-8">
               ...
               <div class="info-bar">
                    ...
                    <span><i class="fa fa-comments"></i><a data-href="<%=couponDetails %>?vc=<%=vd.getId()%>#comment" rel="nofollow" class="btn-cmt"><%=p.getProperty("public.coupon.comment")%></a></span>
                   ...
                   <%if ("1".equals(homeConfig.getVote())) { %>
                    <!--<span>
                        ...
                        <a class="heartstar heart pointer"><i class="fa fa-heart-o" cid="<%=vd.getStoreId()%>"></i></a>

<%-- 
    Document   : privacy
    Created on : 4 Mar, 2016, 4 Mar, 2016 12:50:36 PM
    Author     : Vivek
--%>
...
<%  try {
    ...
    String pageType = SystemConstant.PRIVACY;
    String pageTypeFk = "";
...
<html lang="<%=langId%>" itemscope itemtype="https://schema.org/WebPage"> 
  ...
  <head>
    ...
    for (SeoUrl s : seoList) {
        if (SystemConstant.PRIVACY.equals(s.getPageType())) {
     ...
     <div class="store-middle">
        <div class="container wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="600ms">
            <div class="row">
                ...
                <!-- -------------------CMS Pages Start------------------------->
                 <%
                    List<Privacy> privacyList = home.getPrivacy(domainId);
                    if(privacyList != null) {
                    for (Privacy pr : privacyList) {
                      if (pr.getLanguageId().equals(language.getId())) {
                  %>
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="cms-pages" id="outer-panel">
                        <h2><%=p.getProperty("public.home.privacy")%></h2>
                            <%=pr.getPrivacy()%>
                        <!-- -------------------CMS Pages End-------------------------> 
                    </div>   
                </div>
